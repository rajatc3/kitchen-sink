...
public class SecurityConfig {
     ...
     */
    public SecurityConfig(JwtAuthConverter jwtAuthConverter, CorsConfig corsConfig) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.cors(cors -> cors.configurationSource(corsConfig.getUrlBasedCorsConfigurationSource()))
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/", "/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html", "/api/login", "/api/refresh-token").permitAll()
